...
public class FacebookControllerTest {
    ...
    public void doAuthenticateAsyncWith(
        ...
        if (FacebookController.LoginAuthorizationType.PUBLISH.equals(type)) {
            ...
            if (fragment != null) {
                verify(loginManager).logInWithPublishPermissions(fragment, callbackManager, permissions);
            }
        } else {
            if (activity != null) {
            ...
            if (fragment != null) {
                verify(loginManager).logInWithReadPermissions(fragment, callbackManager, permissions);
            }
        }
