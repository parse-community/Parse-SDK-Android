...
public final class ParseTwitterUtils {
    ...
    /**
     * Initializes Twitter for use with Parse. This method must be invoked prior to calling {@link
     * #link(ParseUser, Context, SaveCallback)} and {@link #logIn(Context, LogInCallback)}.
     *
     ...
     * @param user The user to link to a Twitter account.
     * @param context An Android context from which the login dialog can be launched.
     * @param callback Callback for notifying the calling application when the Twitter
     *     authentication has completed, failed, or been canceled.
     ...
     * @param authToken The auth token for the session.
     * @param authTokenSecret The auth token secret for the session.
     * @param callback Callback for notifying that the authentication data has been saved to the
     *     ParseUser.
    ...
    public static Task<ParseUser> logInInBackground(
            String twitterId, String screenName, String authToken, String authTokenSecret) {
        checkInitialization();
        Map<String, String> authData =
                getTwitterController()
                        .getAuthData(twitterId, screenName, authToken, authTokenSecret);
    ...
    /**
     * Unlinks a user from a Twitter account in the background. Unlinking a user will save the
     * user's data.
     *
     * @param user The user to unlink from a Facebook account.
