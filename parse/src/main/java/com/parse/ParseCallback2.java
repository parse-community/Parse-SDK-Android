...
interface ParseCallback2<T1, T2 extends Throwable> {
    /**
     * {@code done(t1, t2)} must be overridden when you are doing a background operation. It is
     * called when the background operation completes.
     *
     * <p>If the operation is successful, {@code t1} will contain the results and {@code t2} will be
     * {@code null}.
     *
     * <p>If the operation was unsuccessful, {@code t1} will be {@code null} and {@code t2} will
     * contain information about the operation failure.
     *
