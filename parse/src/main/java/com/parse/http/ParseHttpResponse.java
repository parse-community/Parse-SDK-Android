...
public final class ParseHttpResponse {
    ...
    public static final class Builder {
         ...
         *
         * @param statusCode The status code of this {@code Builder}.
         ...
         *
         * @param content The content of this {@code Builder}.
         * @return This {@code Builder}.
         */
         ...
         *
         * @param totalSize The total size of this {@code Builder}.
         * @return This {@code Builder}.
         */
         ...
         *
         * @param reasonPhrase The reason phrase of this {@code Builder}.
         * @return This {@code Builder}.
         */
         ...
         *
         * @param contentType The {@code Content-Type} of this {@code Builder}.
         * @return This {@code Builder}.
         */
